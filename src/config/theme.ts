...
export const themePresets = {
  ...
  LIGHT: {
    ...
    calculator: {
      ...
      productActive: "bg-blue-50/70 border-blue-500 text-blue-950 shadow-sm",
      productInactive: "bg-slate-50 border-slate-200 hover:border-slate-300 text-slate-800",
      inputField: "bg-slate-50 border-slate-300 text-slate-900 focus:bg-white focus:border-blue-500",
