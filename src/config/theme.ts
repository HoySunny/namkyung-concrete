 ...
 * - 'LIGHT': 신규 시니어 친화형 고대비 모던 라이트 테마 (기본 적용)
...
export const themePresets = {
  // 1. 신규 시니어 친화형 고대비 라이트 테마
  LIGHT: {
    name: "라이트 테마 (Senior-friendly Bright)",
    isLight: true,

    // 헤더 (Header)
    header: {
      wrapperScrolled: "bg-white/95 text-slate-900 backdrop-blur-md shadow-md py-3 border-b border-slate-200",
      ...
      navLink: "text-slate-700 hover:text-slate-950 hover:bg-slate-100 font-medium",
      navLinkHighlight: "bg-red-50 text-red-600 hover:bg-red-600 hover:text-white border border-red-200 font-semibold",
      ...
      mobileDrawerLink: "text-slate-800 hover:bg-slate-100 hover:text-slate-950",
      mobileDrawerArrow: "text-slate-400",
    },

    // 히어로 섹션 (HeroSection)
    hero: {
      sectionBg: "bg-slate-100 text-slate-900",
      imageBrightness: "brightness-[1.03] contrast-[1.02]",
      // 텍스트 가독성을 확보하면서 드론 항공뷰와 하늘이 맑게 드러나는 고대비 라이트 그라디언트
      overlayLeft: "bg-gradient-to-r from-white/95 via-white/85 to-white/25 sm:to-transparent",
      overlayBottom: "bg-gradient-to-t from-white/60 via-transparent to-transparent",
      badge: "bg-white/95 text-red-700 border-red-200/90 backdrop-blur-md shadow-sm",
      badgeDotPing: "bg-red-500",
      title: "text-slate-950 drop-shadow-sm",
      titleGradient: "text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-rose-600 to-red-700",
      subCopy: "text-slate-800 font-semibold drop-shadow-none",
      subCopyStrong: "text-slate-950 font-bold underline decoration-red-500/80 underline-offset-4",

      // 버튼 스타일
      btnPhone: "bg-red-600 hover:bg-red-700 text-white font-bold text-base shadow-xl shadow-red-600/30 border border-red-500 transition-all transform hover:-translate-y-0.5",
      btnCatalog: "bg-white hover:bg-slate-50 text-slate-900 font-bold text-base border-2 border-slate-300 backdrop-blur-md shadow-md transition-all hover:border-slate-500 hover:shadow-lg",
      btnCalculator: "bg-slate-900 hover:bg-slate-800 text-white font-bold text-base border border-slate-800 shadow-md transition-all hover:shadow-lg",
      btnQuote: "bg-white hover:bg-slate-50 text-slate-800 font-bold text-base border-2 border-slate-300 backdrop-blur-md shadow-md transition-all hover:border-slate-500 hover:shadow-lg",

      // 하단 카운터 메트릭 카드
      metricBorderTop: "border-t border-slate-300/80",
      metricCard: "bg-white/95 border border-slate-200/90 backdrop-blur-md hover:border-red-300 shadow-md hover:shadow-xl transition-all",
      metricLabel: "text-slate-600 font-bold",
      metricValue: "text-slate-950 font-mono drop-shadow-none",
      metricUnit: "text-red-600 font-black",
    ...
    calculator: {
      ...
      panelCard: "bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-xl space-y-6",
      ...
      resultBoxHighlight: "bg-red-50/80 border-red-200",
  ...
  ORIGINAL: {
    ...
    hero: {
      ...
      overlayLeft: "bg-gradient-to-r from-slate-950/50 via-slate-900/25 to-transparent",
      overlayBottom: "bg-gradient-to-t from-slate-950/40 via-transparent to-transparent",
      badge: "bg-slate-950/70 text-red-400 border-red-500/40 backdrop-blur-md shadow-lg",
      badgeDotPing: "bg-red-500",
      title: "text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.85)]",
      titleGradient: "text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-rose-400 to-amber-300",
      subCopy: "text-white font-medium leading-relaxed mb-8 max-w-2xl drop-shadow-[0_2px_8px_rgba(0,0,0,0.85)]",
      subCopyStrong: "text-white font-bold underline decoration-red-500/60 underline-offset-4",

      // 버튼 스타일
      btnPhone: "bg-red-600 hover:bg-red-700 text-white font-bold text-base shadow-xl shadow-red-600/50 border border-red-500 transition-all transform hover:-translate-y-0.5",
      btnCatalog: "bg-slate-900/75 hover:bg-slate-900/90 text-white font-semibold text-base border border-white/30 backdrop-blur-md shadow-lg transition-all hover:border-white/60",
      btnCalculator: "bg-slate-900/75 hover:bg-slate-900/90 text-white font-semibold text-base border border-white/20 backdrop-blur-md shadow-lg transition-all hover:border-white/40",
      btnQuote: "bg-slate-900/75 hover:bg-slate-900/90 text-white font-semibold text-base border border-white/20 backdrop-blur-md shadow-lg transition-all hover:border-white/40",
